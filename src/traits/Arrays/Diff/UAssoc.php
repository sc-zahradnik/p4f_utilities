...
/**
 * @url http://php.net/manual/en/function.array-diff-uassoc.php
 */
trait UAssoc{
    /**
     * Computes the difference of arrays with additional index check which is performed by a user supplied
     * callback function.
     ...
     *                                          than the second. Note that before PHP 7.0.0 this integer had
     ...
     */
    public static function diffUassoc(array $array1, array $array2):array{
    ...
    public static function diff_uassoc($array1, $array2){
        return call_user_func_array([self, "diffUassoc"], func_get_args());
    }
}
